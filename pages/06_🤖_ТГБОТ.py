...
with st.echo(code_location="below"):
    ...
    st.write("Чтобы воспользоваться ботом, напишите ему в тг @shurovbogbot. Идея бота в том, что вы можете написать ему номер машины в формате А777МР77 кириллическими буквами и он вам расскажет марку и модель этой машины.")
