...
with st.echo(code_location="below"):
    ...
    st.write("Теперь вы можете посмотреть на карте, где живут владельцы той или иной модели этих двух марок, но перед этим выберите 'нет' на панели слева, иначе вам опять придется ждать вечность.")
